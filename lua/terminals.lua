...
M.setup = function(args)
  ...
  vim.keymap.set({ "n", "i", "v" }, "<LeftDrag>", function()
    require("terminals.logic")._handle_mouse_dragged()
  end, { silent = true })
  ...
  vim.keymap.set({ "n", "i", "v" }, "<ScrollWheelUp>", function()
    require("terminals.logic")._handle_scroll("up", -1)
  end, { silent = true })
  vim.keymap.set({ "n", "i", "v" }, "<ScrollWheelDown>", function()
    require("terminals.logic")._handle_scroll("down", 1)
  end, { silent = true })
  vim.keymap.set({ "n", "i", "v" }, "<ScrollWheelLeft>", function()
    require("terminals.logic")._handle_scroll("left", -1)
  end, { silent = true })
  vim.keymap.set({ "n", "i", "v" }, "<ScrollWheelRight>", function()
    require("terminals.logic")._handle_scroll("right", 1)
  end, { silent = true })
end
